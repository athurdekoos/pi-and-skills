...
<execution_context>
@/home/mia/.agents/get-shit-done/workflows/map-codebase.md
</execution_context>
...
- Before /skill:gsd-new-project (brownfield codebases) - creates codebase map first
- After /skill:gsd-new-project (greenfield codebases) - updates codebase map as code evolves
...
7. Offer next steps (typically: /skill:gsd-new-project or /skill:gsd-plan-phase)
</process>
