...
description: Generate tailored sales assets (landing pages, one-pagers, workflow demos) from your deal context. Describe your prospect, audience, and goal — get a polished, branded asset ready to share with customers. Do NOT use for PowerPoint (.pptx) presentations, slide decks, or pitch decks — use the openteams-pptx skill instead.
---
