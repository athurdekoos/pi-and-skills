...
PATCHES_DIR=/home/mia/.agents/gsd-local-patches
...
Local patches are automatically saved when you run /skill:gsd-update
...
```bash
# The manifest will be regenerated on next /skill:gsd-update
