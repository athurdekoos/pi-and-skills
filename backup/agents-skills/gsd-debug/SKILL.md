...
```bash
INIT=$(node /home/mia/.agents/get-shit-done/bin/gsd-tools.cjs state load)
```

Extract `commit_docs` from init JSON. Resolve debugger model:
```bash
DEBUGGER_MODEL=$(node /home/mia/.agents/get-shit-done/bin/gsd-tools.cjs resolve-model gsd-debugger --raw)
```
...
- Offer options:
  ...
  - "Plan fix" - suggest /skill:gsd-plan-phase --gaps
  - "Manual fix" - done
